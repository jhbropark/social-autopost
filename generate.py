            ...
            "carousel": {
                ...
                "properties": {
                    ...
                    "points": {
                        ...
                        "items": {
                            "type": "object",
                            "properties": {"title": _S, "body": _S, "image_query": _S},
                            "required": ["title", "body", "image_query"],
                        },
                    },
                    "outro_line": _S,
                },
...
구조: 표지 1장 + 포인트 5장 + 아웃트로(코드가 자동 생성). 저장·체류율을 높이는 교육형 캐러셀.
  ...
  - points: 정확히 5개. 각 {{title: 12자 이내, body: 45자 이내, image_query: 영어 장면 키워드}}.
...
{{
  ...
  "facebook": {{"text": "..."}},
  "linkedin": {{"text": "..."}},
  "carousel": {{"badge": "...", "cover_bold": "...", "cover_accent": "...", "cover_rest": ["..."], "cover_keyword": "...", "facts": ["...", "...", "..."], "caption": "...", "points": [{{"title": "...", "body": "...", "image_query": "..."}}, {{"title": "...", "body": "...", "image_query": "..."}}, {{"title": "...", "body": "...", "image_query": "..."}}, {{"title": "...", "body": "...", "image_query": "..."}}, {{"title": "...", "body": "...", "image_query": "..."}}], "outro_line": "..."}}
}}"""
