...
PLATFORM_ROLES = {
    ...
    "facebook": {
        ...
        "style": ("1인칭 에세이. 첫 줄은 일반론 금지 — 구체적·개인적·역설적 한 문장으로 "
                  ...
                  "짧은 문단마다 빈 줄(\\n\\n)로 끊어 스캔 가능하게. "
                  "마지막 닫기는 매번 형태를 바꿔라 — 질문형만 반복하지 말 것. 구체적 질문 / 독자를 향한 초대(‘~하는 분과 이야기 나눠보고 싶다’) / 여운을 남기는 단언 / 다음 편 예고 중에서 그 글에 맞는 하나를 고른다. "
                  "‘~한 적 있나요/~가 궁금한가요’ 같은 정형 질문과 ‘어떻게 생각하세요’ 류 일반 질문은 금지. "
                  "본문에 외부 링크(URL)를 넣지 말 것(도달 페널티). 해시태그 없음."),
        "length": "350~600자",
    },
    "linkedin": {
        ...
        "style": ("뉴스/분석 톤(엔터·테크 업계 애널리스트 피드 느낌). "
                  ...
                  "★자작 격언·인용구(“…”)는 남발 금지 — 매 글마다 넣지 말 것. 3편 중 1편 정도만, 그것도 진짜 통찰이 있을 때만. "
                  "대부분은 인용부호 없이 본인 단정 문장으로 마무리하라(따옴표로 감싸면 격언처럼 굳어 정형화된다). "
                  "닫기 형태도 매번 바꿔라 — 질문 / 초대 / 단언 / 예고 중 택1, ‘~가 궁금한가요/~한 적 있나요’ 정형 반복 금지. "
